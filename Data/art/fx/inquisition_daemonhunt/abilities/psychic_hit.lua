fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "INQUISITION_DAEMONHUNT/TEXTURES/SPARK_02.DDS",
				},
				property_21 =  
				{
					name = "Mesh",
	...
	{
		effect = "root>lightning_spray_03",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>lightning_spray_03>unit_melee_powersword_lightning_hit_beam_2",
		fx =  
		{
			properties =  
			{
