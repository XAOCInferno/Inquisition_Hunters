fxtypes =  
{
	...
	{
		effect = "root>gk_hearts>__fxtool_private_copy",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "INQUISITION_DAEMONHUNT/GK_TERMI/FX_HEART.TGA",
				},
				property_21 =  
				{
					name = "Mesh",
	...
	{
		effect = "root>gk_termi_fx_canoness",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "INQUISITION_DAEMONHUNT/GK_TERMI/FX_MIRI.TGA",
				},
				property_21 =  
				{
					name = "Mesh",
