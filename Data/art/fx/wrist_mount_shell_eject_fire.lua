fxtypes =  
{
	...
	{
		effect = "root>ammo_shell_eject_storm",
		fx =  
		{
			properties =  
			{
				...
				property_14 =  
				{
					name = "Particle_Fx",
					type = "VARTYPE_STRING",
					value = "ammo_shell_eject_storm_ring",
				},
				property_15 =  
				{
	...
	{
		effect = "root>ammo_shell_eject_storm_ring",
		fx =  
		{
			properties =  
			{
