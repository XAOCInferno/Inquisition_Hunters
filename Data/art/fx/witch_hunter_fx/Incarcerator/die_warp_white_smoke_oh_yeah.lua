fxtypes =  
{
		...
		fx =  
		{
			properties =  
			{
				...
				property_05 =  
				{
					name = "FX6",
					type = "VARTYPE_STRING",
					value = "spawn_ground_steam_combo",
				},
				property_06 =  
				{
					name = "FX7",
	...
	{
		effect = "root>spawn_ground_steam_combo",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>spawn_ground_steam_combo>env_steam_ring_spray",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>spawn_ground_steam_combo>env_steam_ring_spray>env_steam_ring",
		fx =  
		{
			properties =  
			{
