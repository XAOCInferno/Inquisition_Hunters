fxtypes =  
{
	...
	{
		effect = "root>character_shield_beam",
		fx =  
		{
			properties =  
			{
				...
				property_03 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "WITCH_HUNTER_FX/ABILITIES_FX/RELIC_LIGHT_BEAM_GOLD.DDS",
				},
				property_04 =  
				{
					name = "Offset",
	...
	{
		effect = "root>__fxtool_private_copy>wave_beam",
		fx =  
		{
			properties =  
			{
