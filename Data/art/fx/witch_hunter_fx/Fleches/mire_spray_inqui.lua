fxtypes =  
{
	...
	{
		effect = "root>t_water_ring_still_spray>mire_combo",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>t_water_ring_still_spray>mire_combo>holo_bord_ring_01",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>t_water_ring_still_spray>mire_combo>holo_cross_ring_02",
		fx =  
		{
			properties =  
			{
	...
	{
		effect = "root>t_water_ring_still_spray>mire_combo>mire_lys",
		fx =  
		{
			properties =  
			{
				...
				property_20 =  
				{
					name = "Texture",
					type = "VARTYPE_STRING",
					value = "WITCH_HUNTER_FX/FLECHES/INQUI_MIRE.JPG",
				},
				property_21 =  
				{
					name = "Mesh",
