...
GameData["modifiers"]["modifier_02"]["target_type_name"] = [[witch_hunters_adeptus_arbites_hq]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9000501]] -- - Equips Adeptus Arbites Local Headquarters with Heavy-Bolter turret.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9000502]] -- - Detects stealth units.
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_adeptus_arbites_hq_bolter_defense_right_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9000500]] -- Mounted Heavy-Bolter turret (Add-on)
