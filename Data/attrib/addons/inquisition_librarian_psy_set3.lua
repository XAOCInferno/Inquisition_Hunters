...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16022055]] -- - This tome grants to its keeper the psychic powers to enforce the will of the Emperor to the unwary.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16022056]] -- - Allows the Librarian access to several psychic powers that turns the heretical nature of enemies against them.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16022057]] -- - Unlocks Psychic Fortress: A passive aura that disables psychic powers and abilities of nearby enemies.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16022058]] -- - Unlocks Force His Will: The ability to invoke positive, nigh divine energies, to harm and disorient enemies.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$16022059]] -- - Unlocks Weaken Resolve: The ability to brake the determination of enemies and see them crumble.
GameData["ui_info"]["help_text_list"]["text_06"] = [[$16022067]] -- - REQUIRES: Librarium. Only ONE tome can be chosen at a time.
GameData["ui_info"]["icon_name"] = [[inquisition_icons/book4]]
GameData["ui_info"]["screen_name_id"] = [[$16022054]] -- Liber Primus Ordo Seclorum
