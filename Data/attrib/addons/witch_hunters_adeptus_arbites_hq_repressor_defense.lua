...
GameData["ui_hotkey_name"] = [[addon_dark_eldar_rend_soul]]
GameData["ui_index_hint"] = 4
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_id"] = [[$9000000]] -- 
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9000504]] -- - Permanent addon to the Headquarters.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9000505]] -- - Allows the production of Arbites Repressor Tank from this HQ.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$9000266]] -- - Increases both melee and ranged Arbites squads sizes (applies once).
GameData["ui_info"]["help_text_list"]["text_04"] = [[$9000267]] -- - Increases the health of the Arbites HQ.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$9000265]] -- - Each Repressor Depot built, increases the army support cap by 1.
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_adeptus_arbites_hq_repressor_defense_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9000503]] -- Arbites Repressor Depot (Add-on)
