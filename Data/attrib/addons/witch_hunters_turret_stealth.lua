...
GameData["modifiers"]["modifier_03"] = Reference([[modifiers\ability_eldar_shroud_event.lua]])
...
GameData["requirements"]["required_10"]["structure_name"] = [[ebps\races\witch_hunters\structures\witch_hunters_turret_heavy_flamer.lua]]
GameData["time_cost"] = Reference([[tables\time_cost_table.lua]])
GameData["time_cost"]["cost"]["power"] = 250
GameData["time_cost"]["cost"]["requisition"] = 50
GameData["time_cost"]["time_seconds"] = 80
GameData["ui_hotkey_name"] = [[sisters_sanctuary]]
GameData["ui_index_hint"] = 4
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9002311]] -- - Equips this Heavy-Flamer Turret with a powerful Stealth Generator.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9002312]] -- - Renders the structure invisible to the enemy, regardless its size.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$9002313]] -- - Enemy detector units can still reveal the Turret's location.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$9002314]] -- 
GameData["ui_info"]["help_text_list"]["text_05"] = [[$9002315]] -- 
GameData["ui_info"]["help_text_list"]["text_06"] = [[$9002316]] -- 
GameData["ui_info"]["help_text_list"]["text_07"] = [[$9002317]] -- 
GameData["ui_info"]["help_text_list"]["text_08"] = [[$9002318]] -- 
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_addon_turret_stealth]]
GameData["ui_info"]["screen_name_id"] = [[$9002310]] -- Stealth Generator (Add-on)
