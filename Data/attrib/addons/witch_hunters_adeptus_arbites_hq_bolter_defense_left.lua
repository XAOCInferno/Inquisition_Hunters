...
GameData["requirements"]["required_1"]["addon_name"] = [[addons\witch_hunters_adeptus_arbites_hq_bolter_defense_right.lua]]
...
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_adeptus_arbites_hq_bolter_defense_left_icon]]
