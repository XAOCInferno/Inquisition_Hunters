...
GameData["requirements"]["required_1"]["structure_name"] = [[ebps\races\witch_hunters\structures\witch_hunters_adeptus_arbites_listening_post.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9000536]] -- - Fortify this Strategic Point.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9000537]] -- - Fortified Positions produce the Requisition resource at a higher rate.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$9000538]] -- - Fortified Positions are tougher, and are defended by plasma gun-equipped Arbites.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$9000539]] -- - Effective against Infantry and Heavy Infantry.
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_LP_level2_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9000535]] -- Arbites Fortified Position (Add-on)
