...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$93022]] -- - Upgreade Razorback into a Vortimer Razorback .
GameData["ui_info"]["help_text_list"]["text_02"] = [[$93023]] -- - Vortimer Razorback has higher health and gets a dual pysilencer.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$93024]] -- - Vortimer Razorback are tougher, and are equipped with a weapon effective against infantry and heavy infantry and vehicles.
GameData["ui_info"]["icon_name"] = [[inquisition_icons/upgrade_dual_psy]]
GameData["ui_info"]["screen_name_id"] = [[$93020]] -- Vortimer Razorback
