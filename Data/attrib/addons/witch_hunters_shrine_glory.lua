...
GameData["modifiers"]["modifier_02"]["application_type"] = Reference([[type_modifierapplicationtype\tp_mod_apply_to_player.lua]])
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9000513]] -- - Upgrades the Covent Military to the Shrine of Militant Order.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9000514]] -- - Allows the production of more advanced units, like Seraphims and Sororitas Sentinels.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$9000515]] -- - Provides more features to Canoness.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$9000516]] -- - Also strengthens Covent Military structure.
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_addon_seraphim_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9000512]] -- Shrine of Militant Order (Add-on)
