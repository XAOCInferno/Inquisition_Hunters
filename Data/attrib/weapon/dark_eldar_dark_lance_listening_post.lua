...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[Dark_Eldar\Darklance_impact]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$4200001]] -- - A fearsome weapon that fires streams of Dark Matter, punching through even the heaviest armor.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$4200002]] -- - Long range.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$4200003]] -- - Effective against Vehicles and Buildings.
