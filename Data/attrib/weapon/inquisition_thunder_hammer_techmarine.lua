...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16022126]] -- - Replaces the Power Axe of the Techmarine with a thunder hammer.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16022127]] -- - Slow wielding, great impact melee force weapon, that causes severe damage.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16022128]] -- - Has a chance to stun the enemy with each successfully landed swing.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16022129]] -- - Very effective against big enemies, Vehicles, Buildings and enemy Morale.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$16022130]] -- - Less effective against most Infantry types, because of size.
...
GameData["ui_info"]["screen_name_id"] = [[$16022125]] -- Thunder Hammer
