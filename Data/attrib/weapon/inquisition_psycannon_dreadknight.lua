...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"]["entry_16"]["armour_type"]["screen_name_id"] = [[$0]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16021196]] -- - Multi-barrelled psionic cannon, firing psychically charged projectiles.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16021197]] -- - Causes immense damage and has a very long effective range.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16021198]] -- - Has a minimum range as well, and it won't fire within close proximity.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16021199]] -- - Efficient against Infantry and enemy Heroes, also good against Daemons. 
...
GameData["ui_info"]["screen_name_id"] = [[$16021195]] -- Gatling Psilencer
