...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["armour_piercing_types"]["entry_04"]["armour_piercing_value"] = 95
...
GameData["ui_hotkey_name"] = [[witch_hunters_emplaced_grenadelauncher]]
