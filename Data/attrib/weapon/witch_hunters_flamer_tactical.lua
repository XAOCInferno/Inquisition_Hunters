...
GameData["requirements"]["required_2"]["global_addon_name"] = [[addons\witch_hunters_shrine_glory.lua]]
...
GameData["ui_effective_against"]["text_02"] = [[$4400003]] -- Morale
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9000921]] -- - Upgrades one member of the Squad to the indicated heavy weapon.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9000922]] -- - Hand-held flamethrower.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$9000923]] -- - Short Range.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$9000924]] -- - Effective at breaking enemy morale.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$9002118]] -- - Purging Effect: The flames of purification cleanse all infidels, transgressors of faith and Daemons.
...
GameData["ui_info"]["screen_name_id"] = [[$9000920]] -- Sororitas Flamer
