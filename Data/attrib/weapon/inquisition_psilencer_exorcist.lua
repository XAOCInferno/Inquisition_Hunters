...
GameData["kill_enemy_at_percent_life_cooldown_time"] = 8
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16022261]] -- - A psionic multi-barrelled weapon, with origins lost on an non-Terra civilisation.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16022262]] -- - Usable only by psykers; fuelled by their psych, it fires with nigh unfailing accuracy.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16022263]] -- - Exceptionally accurate on the move as well, perfect for pursuing fleeing enemies.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16022264]] -- - Has a chance to instantly kill wounded infantry troops. Ignores covers.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$16022265]] -- - Medium to Long range.
GameData["ui_info"]["help_text_list"]["text_06"] = [[$16022266]] -- - Extremely effective against Infantry, Heavy Infantry, Commanders and Daemons.
GameData["ui_info"]["help_text_list"]["text_07"] = [[$16022267]] -- - Poor efficiency against armoured targets, causes only minimal damage.
GameData["ui_info"]["help_text_list"]["text_08"] = [[$16022268]] -- 
...
GameData["ui_info"]["screen_name_id"] = [[$16022260]] -- Psilencer
