...
GameData["requirements"]["required_1"]["structure_name"] = [[ebps\races\witch_hunters\structures\witch_hunters_inquisition_armorium.lua]]
...
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_upgrade_twin_lascannon_icon]]
