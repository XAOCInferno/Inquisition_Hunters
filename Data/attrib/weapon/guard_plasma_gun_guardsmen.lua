...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$690204]] -- - Upgrades one member of the squad to the indicated heavy weapon.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$690205]] -- - All plasma weapons use magnetic fields to project super-heated streams of molten plasma.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$690206]] -- - Effective against Heavy Infantry.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$690207]] -- - Weapon can be fired while unit is moving, but is less accurate than if the unit were stationary.
