...
GameData["requirements"]["required_2"]["structure_name"] = [[ebps\races\witch_hunters\structures\witch_hunters_armorium.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9002611]] -- - Upgrades the Incinerator of the Sentinel to the indicated heavy weapon.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9002612]] -- - Artillery weapon. Cannot target Aircraft. Unit must me stationary to fire it.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$9002613]] -- - Fires Fragmentation Rockets that break into shrapnel on impact to rip through infantry.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$9002614]] -- - The explosions also causes massive knock-back, causing substantial infantry disruption.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$9002615]] -- - Extremely Long Range. Has a minimum firing range, so it is totally defenceless in melee.
GameData["ui_info"]["help_text_list"]["text_06"] = [[$9002616]] -- - Effective against Infantry and Heavy Infantry.
GameData["ui_info"]["help_text_list"]["text_07"] = [[$9002617]] -- 
GameData["ui_info"]["help_text_list"]["text_08"] = [[$9002618]] -- 
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_upgrade_rocket_launcher_sentinel]]
...
GameData["ui_info"]["screen_name_id"] = [[$9002610]] -- Rocket Launcher
