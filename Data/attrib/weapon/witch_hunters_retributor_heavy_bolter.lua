...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$4400027]] -- - Upgrades one member of the squad to the indicated heavy weapon.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$4400028]] -- - Fires large caliber bolt rounds effective at punching through most infantry armor.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$4400029]] -- - Long Range.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$4400030]] -- - Effective against Infantry.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$4400031]] -- - Unit must be stationary to fire this weapon.
