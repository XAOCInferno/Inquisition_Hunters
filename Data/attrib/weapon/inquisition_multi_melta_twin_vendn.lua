...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[Guard\Weapons\melta2\2_small]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[Guard\Weapons\melta2\2_small]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[Guard\Weapons\melta2\2_small]]
...
GameData["ui_info"]["help_text_id"] = [[$16020143]] -- - Multi-Melta.
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16021043]] -- - Upgrades the dual incinerators of the Dreadnought to the indicated heavy weapon.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16021044]] -- - Devastating beam weapon that causes extreme damage to armoured targets.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16021045]] -- - Short to medium-ranged.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16021046]] -- - Extremely effective against Vehicles, very effective against Buildings.
...
GameData["ui_info"]["screen_name_id"] = [[$16021042]] -- Twin-Linked Multi-Meltas
