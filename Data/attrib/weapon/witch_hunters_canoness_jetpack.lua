...
GameData["requirements"]["required_2"]["research_name"] = [[research\witch_hunters_research_canoness_jetpack.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\required_mobvalue.lua]])
GameData["requirements"]["required_3"]["mobvalue_required"] = 100
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9000970]] -- - Jetpacks quickly around and over the battlefield, even over impassable terrain.
...
GameData["ui_info"]["screen_name_id"] = [[$9000968]] -- Canoness Personal Jetpack
