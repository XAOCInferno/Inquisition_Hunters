...
GameData["squad_requirement_ext"]["requirements"]["required_2"]["squad_table"]["squad_01"] = [[sbps\races\inquisition_daemonhunt\inquisition_squad_dreadnought_venerable_hf.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$16022151]] -- - Walker Vehicle. Siege Unit. A revered Grey Knight warrior of legendary status.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16022152]] -- - Exceptional melee combatant, able to decimate enemy structures and vehicles.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16022153]] -- - Can upgrade its weapons with a selection of close-to-medium combat weaponry.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$16022154]] -- - Can be directly teleported from Domus Astra Telepathica into the battlefield.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$16022155]] -- - Note: The Grey Knights army can requisition only one Venerable Dreadnought.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$16022156]] -- - Extremely effective against all unit types, excels in melee combat.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_07"] = [[$16022157]] -- 
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_08"] = [[$16022158]] -- 
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[inquisition_icons/dreadnought_venerable]]
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$16022150]] -- Venerable Assault Dreadnought
