...
GameData["squad_combat_stance_ext"]["ranged_attackrange"] = 42
...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\witch_hunters\troops\witch_hunters_zealot.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$9002691]] -- - Elite Infantry.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$9002692]] -- - Called upon by the Ordo Hereticus to hunt down witchery and deception.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$9002693]] -- - Unfailable resolve, with immunity to morale damage and high regeneration.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$9002694]] -- - Many weapon upgrade choices, with emphasis in ranged combat.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$9002695]] -- - They tend to chose one specific weapon as a team, to specialise against specific threats.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$9002696]] -- - Effective against Infantry. Can be effective against most targets when upgraded.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_07"] = [[$9002697]] -- 
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_08"] = [[$9002698]] -- 
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_zealot_icon]]
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$9002699]] -- Zealots Squad
