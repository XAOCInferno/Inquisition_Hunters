...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\witch_hunters\troops\witch_hunters_exorcist_sanctorum.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$9002421]] -- - Vehicle. Artillery Tank. Very long sight range. Sanctorum Pattern.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$9002422]] -- - Provides devastating long-range fire support, damaging only transgressors of faith.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$9002423]] -- - Its dual missile launchers have multiple barrels firing a hail of missiles on the enemy.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$9002424]] -- - Very effective against all Infantry types, Vehicles and Buildings.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$9002425]] -- 
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$9002426]] -- 
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_07"] = [[$9002427]] -- 
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_08"] = [[$9002428]] -- 
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_exorcist_sanctorum_icon]]
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$9002420]] -- Inquisition Exorcist
