...
GameData["squad_cannibalize_ext"]["souls_radius"] = 80
...
GameData["squad_formation_ext"]["idle_formation"] = [[formations\witch_hunters_archoflagellant.lua]]
GameData["squad_loadout_ext"] = Reference([[sbpextensions\squad_loadout_ext.lua]])
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\witch_hunters\troops\witch_hunters_archoflagellant.lua]]
...
GameData["squad_reinforce_ext"]["cost"]["time_seconds"] = 14.5
...
GameData["squad_requirement_ext"]["requirements"]["required_10"]["structure_name"] = [[ebps\races\witch_hunters\structures\witch_hunters_inquisition_armorium.lua]]
GameData["squad_transportable_ext"] = Reference([[sbpextensions\squad_transportable_ext.lua]])
GameData["squad_ui_ext"] = Reference([[sbpextensions\squad_ui_ext.lua]])
GameData["squad_ui_ext"]["multi_select_priority"] = 5
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$9000094]] -- - Elite Infantry.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$9000095]] -- - Armed with implanted power-scourges, Arco-Flagellants are berserk killing units that feel no pain.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$9000096]] -- - Augmented with physical surgery, their tough bodies can be pumped full of combat stimms.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$9000097]] -- - Once injectors activated, Arco-Flagellants will have no sense of self-preservation.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$9002674]] -- - They can use their hideous Skin Grafting ability, to path themselves with flesh from the 'freshly' fallen.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$9000098]] -- - They also boast tremendous regeneration capabilities, especially when inert (idle).
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_07"] = [[$9000099]] -- - Very effective against Infantry and Daemons.
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_arcoflagellant_icon]]
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$9000093]] -- Arco-Flagellant Squad
