...
GameData["squad_loadout_ext"]["trooper_base"]["type"] = [[ebps\races\witch_hunters\troops\witch_hunters_eversor.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$9000078]] -- - Elite Force. Stealth Unit. Immune to morale attacks. Immune to poison.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$9000079]] -- - His exceptional training enables him to detect infiltrated and invisible units.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$9000080]] -- - Each needle hit of his executioner pistol weakens muscles, crippling melee prowess.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$9000081]] -- - Combat drugs allow Eversor to charge and attack more efficiently in close combat.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$9000082]] -- - As their bodies are unstable, at death they can explode hurting nearby enemies.
...
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$9000077]] -- Eversor Assassin
