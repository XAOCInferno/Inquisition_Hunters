...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[unit_ability_fx/melta_bomb_explosion_bt_mod]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[unit_ability_fx/melta_bomb_explosion_bt_mod]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[unit_ability_fx/melta_bomb_explosion_bt_mod]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[unit_ability_fx/melta_bomb_explosion_bt_mod]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[unit_ability_fx/melta_bomb_explosion_bt_mod]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16020351]] -- - Uses a Melta Bomb on a targeted unit.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16020352]] -- - Left-click and target an enemy vehicle or building to activate.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16020353]] -- - Does massive damage to enemy vehicles and buildings.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16020354]] -- - Does massive damage to enemy vehicles and buildings
GameData["ui_info"]["help_text_list"]["text_05"] = [[$16020355]] -- - Melta Bombs are very short range and do not affect infantry.
GameData["ui_info"]["icon_name"] = [[inquisition_icons/meltabombs_ability]]
GameData["ui_info"]["screen_name_id"] = [[$16020350]] -- Melta Bombs
