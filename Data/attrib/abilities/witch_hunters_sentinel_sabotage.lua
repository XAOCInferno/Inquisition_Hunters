...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["max_lifetime"] = 40
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"] = Reference([[modifiers\enable_garrison.lua]])
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"]["value"] = -1
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_02"]["max_lifetime"] = 40
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9000703]] -- - Allows the PowerLift to deactivate enemy's listening points and turrets for a while.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9000704]] -- - Left-click and target an enemy building to activate.
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_sentinel_sabotage_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9000702]] -- Arbites Sentinel PowerLift Sabotage 
