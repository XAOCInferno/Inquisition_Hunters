...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["modifier"]["value"] = 0.20
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_04"]["modifier"]["value"] = 0.20
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_05"]["modifier"]["value"] = 0.20
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_06"]["modifier"] = Reference([[modifiers\enable_infiltration.lua]])
...
GameData["child_ability_name"] = [[inquisition_eversor_combat_drugs_child]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16020400]] -- - The eversor inject his combat Drugs massively increasing his damage output for a short duration.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16020401]] -- - The combat drugs also enhance his body making him take significantly less damage.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16020402]] -- -  The eversor suffers hp degenration and can't infiltrate for the duration of the drugs.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16020403]] --  Left-click to activate.
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_eversor_berserk_icon]]
GameData["ui_info"]["screen_name_id"] = [[$16020399]] -- Eversor Combat Drugs
