...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$4300056]] -- - Allows the Penitent Engine to approach enemies at blinding speed.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$4300057]] -- - Holy Rage only functions if Penitent Engine is in the Assault Stance.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$4300058]] -- - Left-click on an enemy unit or location to activate.
