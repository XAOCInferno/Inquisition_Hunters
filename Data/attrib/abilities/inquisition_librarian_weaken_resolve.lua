...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["modifier"] = Reference([[modifiers\ability_weaken_resolve_event.lua]])
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16022211]] -- - Psychic mental attack that crushes the spirit of an enemy squad.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16022212]] -- - Halves maximum morale and reduces morale recovery rate of the targeted squad.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16022213]] -- - Has no effect on units not affected by morale, like vehicles.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16022214]] -- - Left-click and target an enemy squad to activate.
...
GameData["ui_info"]["icon_name"] = [[inquisition_icons/weakenresolve_icon]]
GameData["ui_info"]["screen_name_id"] = [[$16022210]] -- Weaken Resolve
