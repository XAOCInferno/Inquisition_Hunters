...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[witch_hunters/divine_shield_01]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[witch_hunters/divine_shield_01]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[witch_hunters/divine_shield_01]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[witch_hunters/divine_shield_01]]
...
GameData["requirements"]["required_2"]["research_name"] = [[research\witch_hunters_research_actoffaith_emperor_light.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\required_mobvalue.lua]])
GameData["requirements"]["required_3"]["mobvalue_required"] = 5
GameData["requirements"]["required_3"]["proximity_required"] = 25
GameData["requirements"]["required_10"] = Reference([[requirements\required_total_pop.lua]])
GameData["requirements"]["required_10"]["is_display_requirement"] = true 
GameData["spawned_entity_name"] = [[]]
GameData["speech_directory"] = [[ability/witch_hunters_actoffaith_emperor_light]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9000611]] -- - Protects Celestians from morale damage and all wounds for a short period of time.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9000612]] -- - The presence of an Imagifer is mandatory for Celestians to cast this Act of Faith.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$9002119]] -- - For a prayer to be answered, a symbolic amount of requisition must be devoted to the Divine Emperor.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$9000613]] -- - Left-click to activate.
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_actoffaith_emperor_light_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9000610]] -- Light of the Emperor Act of Faith (Prayer)
