...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_07"]["modifier"] = Reference([[modifiers\builder_idle_event.lua]])
...
GameData["speech_directory"] = [[ability/witch_hunters_sentinel_repair]]
GameData["target_ground"] = false
GameData["target_leader_in_squad"] = false
GameData["target_self"] = false
GameData["ui_hotkey_name"] = [[sisters_holy_reliquary]]
GameData["ui_index_hint"] = 2
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9002251]] -- - Allows the Sentinel PowerLift to fully repair itself, by initiating its internal maintenance protocols.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9002252]] -- - While active, all PowerLift systems are shut down and thus the vehicle cannot move or use its claws.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$9002253]] -- - Constructing and repairing capabilities are also temporarily disabled, but resume immediately after.
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_powerlift_repair_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9002250]] -- Vehicle Auto-Repair
