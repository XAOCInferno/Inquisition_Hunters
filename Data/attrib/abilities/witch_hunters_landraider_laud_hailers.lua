...
GameData["speech_directory"] = [[ability/laud_hailers]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9002291]] -- - Proclaiming the Emperor's power in heavenly tones, they fill the enemies with dread.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9002292]] -- - Attacks morale of the enemy's squads, with dire intensity and fervour.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$9002293]] -- - The Redeemer version of Laud Hailers is severe, but has a very short duration.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$9002294]] -- - Has no effect on units not affected by morale.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$9002295]] -- - Left-click to cast Laud Hailers and crush enemy unit's ability to regenerate morale.
GameData["ui_info"]["help_text_list"]["text_06"] = [[$9002296]] -- 
GameData["ui_info"]["help_text_list"]["text_07"] = [[$9002297]] -- 
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_immolator_laud_hailers_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9002290]] -- Redeemer Laud Hailers
