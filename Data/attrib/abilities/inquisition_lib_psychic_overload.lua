...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[tau/Abilities/snare_trap_trigger]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[tau/Abilities/snare_trap_trigger]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[tau/Abilities/snare_trap_trigger]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[tau/Abilities/snare_trap_trigger]]
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"]["value"] = 1.4
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_02"]["modifier"]["value"] = 0.3
...
GameData["child_ability_name"] = [[inquisition_lib_psychic_overload_child]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16020485]] -- - The Librarian cast bolt of instable psychic energy.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16020486]] -- - The instable energy will make the targeted squad instable move quicker but massively lose accuracy for a short period.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16020487]] -- - After that the Targeted squad energy is drained making them slower then normal.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16020488]] -- - the squad Takes damage overtime during the next phase of the ability
GameData["ui_info"]["help_text_list"]["text_05"] = [[$16020489]] -- - Left-click and target an enemy squad to activate.
GameData["ui_info"]["help_text_list"]["text_06"] = [[$16020490]] -- - Does not affect vehicles.
GameData["ui_info"]["icon_name"] = [[inquisition_icons/psychic_overload_ability]]
GameData["ui_info"]["screen_name_id"] = [[$16020484]] -- Energy Instability
