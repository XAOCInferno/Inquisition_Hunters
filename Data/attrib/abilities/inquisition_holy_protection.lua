...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["modifier"]["value"] = 2.5
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16020344]] -- - Sends the Priest and his squad into a fanatical frenzy.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16020345]] -- - Squad is immune to all damage while in this frenzied state.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16020346]] -- - Squad is immune to all damage while in this frenzied state
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16020347]] -- - Squad is immune to all damage while in this frenzied state
GameData["ui_info"]["icon_name"] = [[sisters_icons/ability_divine_retribution]]
GameData["ui_info"]["screen_name_id"] = [[$16020343]] -- Fanaticism
