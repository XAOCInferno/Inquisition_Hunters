...
GameData["speech_directory"] = [[ability/witch_hunters_sentinel_combat]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9000700]] -- - Allows Arbites Sentinel PowerLift to activate its power combat claws.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9000701]] -- - Unfortunately, as all energy is driven to its claws, it cannot accelerate any more.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$9000826]] -- - Left-click to activate. Left-click again to deactivate.
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_arbites_builder_combat_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9000699]] -- Arbites Sentinel PowerLift Power Combat Claws
