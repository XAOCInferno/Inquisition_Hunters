...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_09"]["modifier"] = Reference([[modifiers\ability_tau_shield_event.lua]])
...
GameData["ui_info"]["help_text_list"]["text_04"] = [[$9000655]] -- - Left-click to activate.
