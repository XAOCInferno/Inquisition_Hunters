...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16022962]] -- - Causes a powerful electrical overload on a vehicle or building.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16022963]] -- - Left click and select a building or vehicle to activate.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16022964]] -- - Buildings are rendered useless for a brief period of time (no unit production, no research).
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16022965]] -- - Vehicles are disabled for a brief period (no combat, no movement, decreased armour rating).
