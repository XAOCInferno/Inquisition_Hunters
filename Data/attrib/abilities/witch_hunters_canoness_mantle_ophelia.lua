...
GameData["speech_directory"] = [[ability/witch_hunters_canoness_mantle_ophelia]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9000291]] -- - When used, temporarily keeps the Canoness alive during times of dire self-peril.
