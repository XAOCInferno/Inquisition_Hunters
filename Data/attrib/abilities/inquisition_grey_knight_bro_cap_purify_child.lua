...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_08"]["max_lifetime"] = 1
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_08"]["modifier"] = Reference([[modifiers\enable_squad_jump.lua]])
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_08"]["modifier"]["probability_of_applying"] = 0.6000000238
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_09"]["max_lifetime"] = 1
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_09"]["modifier"] = Reference([[modifiers\enable_squad_reinforcement.lua]])
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_10"]["max_lifetime"] = 1
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_10"]["modifier"] = Reference([[modifiers\enable_squad_upgrades.lua]])
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16022972]] -- - The Grey Knight Commander invokes the Emperor's fire on a zone.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16022973]] -- - The enemy cannot move, fight nor use special abilities.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16022974]] -- - Causes damage and lowers enemy's armour.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16022975]] -- - No effect on buildings or vehicles.
GameData["ui_info"]["icon_name"] = [[inquisition_icons/purge_ability]]
GameData["ui_info"]["screen_name_id"] = [[$16022970]] -- Purification
