...
GameData["requirements"]["required_1"]["structure_name_exclusive"] = [[ebps\environment\gameplay\witch_hunters_techcelestian_fix.lua]]
...
GameData["spawned_entity_name"] = [[ebps\environment\gameplay\witch_hunters_techcelestian_fix.lua]]
