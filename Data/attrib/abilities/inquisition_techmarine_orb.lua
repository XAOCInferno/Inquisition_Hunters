...
GameData["speech_directory"] = [[ability/bombs]]
GameData["stop"] = false
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16020407]] -- - Throws an Emp bomb at the targeted location or enemy.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16020408]] -- - stuns enemy vehicles and building caught in the blast and disables their weaponary temporarily.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16020409]] -- - Left-click and target a location or an enemy vehicle or building to activate.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16020410]] -- - Has no effect on infantry or commanders.
GameData["ui_info"]["icon_name"] = [[inquisition_icons/fraggrenade_ability]]
GameData["ui_info"]["screen_name_id"] = [[$16020406]] -- Orb of the Omnissiah.
GameData["ui_invalid_target_msg"] = [[$9000645]] -- This ability can only be used on enemy vehicles or building!
