...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$4500015]] -- - Warps the minds of the enemy, causing them to temporarily join your side. Only affects infantry.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$4500016]] -- - Temporarily grants the player control of all nearby enemy infantry.
