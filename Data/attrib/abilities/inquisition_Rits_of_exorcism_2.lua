...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_02"]["modifier"] = Reference([[modifiers\ability_necron_phase_shift_event.lua]])
...
GameData["requirements"]["required_10"]["squad_name"] = [[sbps\races\inquisition_daemonhunt\inquisition_squad_exorcist_sister.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16022865]] -- Banish the Tainted and daemons to the warp.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16022866]] -- - Targeted enemy squad gets bansihed for a short period of time.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16022867]] -- - also suffer huge health degeneration for that period.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16022867]] -- - Greater daemons are too strong to be bansihed but signficant suffer health degeneration
GameData["ui_info"]["help_text_list"]["text_05"] = [[$16022868]] -- - Left-click and target an enemy squad or greater daemons to activate
GameData["ui_info"]["icon_name"] = [[inquisition_icons/rally_ability]]
GameData["ui_info"]["screen_name_id"] = [[$16022864]] -- Rits of Exorcism
