...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$704351]] -- - Vespids use their neutron blasters to temporarily resonate an asynchronous frequency.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$704354]] -- - This frequency has a devastating effect on building armor and weakens it considerably.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$704352]] -- - The effect causes the targeted building to take double damage for a short period of time.
GameData["ui_info"]["icon_name"] = [[tau_icons/tau_devour_icon]]
GameData["ui_info"]["screen_name_id"] = [[$704350]] -- Destabilization
