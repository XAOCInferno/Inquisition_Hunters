...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[unit_ability_fx\embolden]]
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"] = Reference([[modifiers\enable_hardpoint_02.lua]])
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["modifier"]["value"] = -11
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_02"]["modifier"] = Reference([[modifiers\enable_hardpoint_03.lua]])
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_02"]["modifier"]["value"] = 11
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16020921]] -- - The Terminators strengthen their resolve, delivering mighty swings with their Halberds.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16020922]] -- - For the duration of the ability their melee strikes penetrate even the thickest armour.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16020923]] -- - Additionally, their mighty strikes cause excessive damage against vehicles of all types.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16020924]] -- - Attached commanders also gain the benefits of Hammerhand with their melee strikes.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$16020925]] -- - Left-click to activate.
GameData["ui_info"]["help_text_list"]["text_06"] = [[$16020926]] -- 
GameData["ui_info"]["help_text_list"]["text_07"] = [[$16020927]] -- 
GameData["ui_info"]["icon_name"] = [[inquisition_icons/ability_hammerhand]]
GameData["ui_info"]["screen_name_id"] = [[$16020920]] -- Hammerhand
