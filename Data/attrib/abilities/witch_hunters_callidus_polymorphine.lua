...
GameData["child_ability_name"] = [[witch_hunters_callidus_polymorphine_2]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9002181]] -- - With this drug, the Callidus deludes enemies into thinking her to be an ally, forcing them to cease fire.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9002182]] -- - All enemies are confused by Callidus'es new appearance and do not fire their weapons, even if fired back.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$9002183]] -- - Their melee combat potential is not affected though, as they can discern friend from foe in close encounters.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$9002184]] -- - For as long as the drug is in effect, the assassin will not fire her ranged weapon to avoid being uncovered. 
GameData["ui_info"]["help_text_list"]["text_05"] = [[$9002185]] -- - Left-click to activate.
GameData["ui_info"]["help_text_list"]["text_06"] = [[$9002186]] -- 
GameData["ui_info"]["help_text_list"]["text_07"] = [[$9002187]] -- 
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_callidus_polymorphine_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9002180]] -- Shape-Altering Polymorphine Drug
