...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["modifier"]["value"] = 84
...
GameData["requirements"]["required_1"]["research_name"] = [[research\witch_hunters_research_incarcerator_horror_torture.lua]]
GameData["requirements"]["required_2"] = Reference([[requirements\required_health.lua]])
GameData["requirements"]["required_2"]["min_health_fraction"] = 0.05000000075
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9000823]] -- - The Inquisition employs its occult knowledge to torture to death the imprisoned Warp Daemon.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9000824]] -- - The energy unleashed by the Daemon's torment, is used to increase the vehicle's damage output.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$9002139]] -- - When enabled, the Incarcerator's energy attacks are effective against all targets.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$9000825]] -- - NOTE: The warp energy siphoned from the daemon corrupts the Incarcerator itself!
GameData["ui_info"]["help_text_list"]["text_05"] = [[$9000826]] -- - Left-click to activate. Left-click again to deactivate.
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_incarcerator_horror_torture_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9000822]] -- Incarcerator Torture Instructions
