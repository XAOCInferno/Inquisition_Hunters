...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_05"]["modifier"] = Reference([[modifiers\chaos_flamer_hit_event.lua]])
...
GameData["child_ability_name"] = [[inquisition_cleansing_flame_child_10]]
