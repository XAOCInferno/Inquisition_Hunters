...
GameData["entity_busy_time"] = 0.25
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16020331]] -- - Psychic mental attack that crushes the spirit of an enemy squad.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16020332]] -- - Halves maximum morale and reduces morale recovery rate of the targeted squad.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16020333]] -- - Has no effect on units not affected by morale, like vehicles.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16020334]] -- - Left-click and target an enemy squad to activate.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$16020335]] -- - Left-click and target an enemy squad to activate
...
GameData["ui_info"]["screen_name_id"] = [[$16020330]] -- Weaken Resolve
