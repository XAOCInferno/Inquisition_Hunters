...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16020374]] -- - The Brotherhood Champion sanctify the spirit and mind of the Targeted friendly squad.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16020375]] -- - Immdeiatly Restoring a huge proportion of the squad ability cooldown
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16020376]] -- - Allowing the friendly squad to almost recast their abilities which are on cooldown.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$4100108]] -- - Left-click and target an allied unit to activate.
GameData["ui_info"]["icon_name"] = [[inquisition_icons/ability_battlefield_medics]]
GameData["ui_info"]["no_button"] = false 
GameData["ui_info"]["screen_name_id"] = [[$16020373]] -- Spiritual Sanctification
