...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_03"]["modifier"]["value"] = 0.25
...
GameData["child_ability_name"] = [[inquisition_cleansing_flame_child_1]]
...
GameData["speech_directory"] = [[ability/flames]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16020961]] -- - The Knight of the Flame conjures the flames of purification to strike the defiers of Inquisition.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16020962]] -- - Creates a small area filled with cleansing fire, damaging all enemies caught within.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16020963]] -- - The pyre also causes immense morale damage, and is devastating against daemons.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16020964]] -- - Armoured targets like vehicles and buildings are totally unaffected by the flames.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$16020965]] -- - Left-click and target an enemy squad or directly on the ground, to activate.
GameData["ui_info"]["help_text_list"]["text_06"] = [[$16020966]] -- 
GameData["ui_info"]["help_text_list"]["text_07"] = [[$16020967]] -- 
GameData["ui_info"]["icon_name"] = [[inquisition_icons/cleansing_flames]]
GameData["ui_info"]["screen_name_id"] = [[$16020960]] -- Cleansing Flames
GameData["ui_instructional_msg"] = [[$16020968]] -- Left-click and target any enemy Infantry or Daemon unit, or directly on the ground, to conjure a cleansing pyre.
GameData["ui_invalid_target_msg"] = [[$16020969]] -- This ability only target enemy Infantry or Daemon units of all types, or can be targeted directly on the ground!
