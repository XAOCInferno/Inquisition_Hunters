...
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[witch_hunters/faith_shield]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[witch_hunters/faith_shield]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[witch_hunters/faith_shield]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[witch_hunters/faith_shield]]
...
GameData["requirements"]["required_2"]["research_name"] = [[research\witch_hunters_research_actoffaith_divine_guidance.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\required_mobvalue.lua]])
GameData["requirements"]["required_3"]["mobvalue_required"] = 8
...
GameData["speech_directory"] = [[ability/witch_hunters_actoffaith_divine_guidance]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9000615]] -- - Divine Guidance highly increases Retributors' weapon damages.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9000616]] -- - To use Act of Faith, Retributor Squads have to be composed of at least 8 members.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$9000672]] -- - Presence of the Sacred Standard in the Squad lowers the required member threshold.
...
GameData["ui_info"]["help_text_list"]["text_05"] = [[$9000670]] -- 
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_actoffaith_divine_guidance_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9000614]] -- Divine Guidance Act of Faith (Prayer)
