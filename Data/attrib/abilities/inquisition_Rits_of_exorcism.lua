...
GameData["child_ability_name"] = [[inquisition_Rits_of_exorcism_1]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16020460]] -- Banish the Tainted and daemons to the warp.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16020461]] -- - Targeted enemy squad gets bansihed for a short period of time.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16020462]] -- - also suffer huge health degeneration for that period.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16020463]] -- - Greater daemons are too strong to be bansihed but signficant suffer health degeneration
GameData["ui_info"]["help_text_list"]["text_05"] = [[$16020464]] -- - Left-click and target an enemy squad or greater daemons to activate
GameData["ui_info"]["icon_name"] = [[inquisition_icons/rally_ability]]
GameData["ui_info"]["screen_name_id"] = [[$16020459]] -- Rits of Exorcism
