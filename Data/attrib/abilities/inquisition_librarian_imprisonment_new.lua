...
GameData["area_effect"]["weapon_damage"]["armour_damage"]["hit_events"] = Reference([[tables\hit_event_table.lua]])
GameData["area_effect"]["weapon_damage"]["armour_damage"]["hit_events"]["entry01"]["event"] = [[unit_ability_fx/imprisonment_30secs]]
GameData["area_effect"]["weapon_damage"]["armour_damage"]["hit_events"]["entry02"]["event"] = [[unit_ability_fx/imprisonment_30secs]]
GameData["area_effect"]["weapon_damage"]["armour_damage"]["hit_events"]["entry03"]["event"] = [[unit_ability_fx/imprisonment_30secs]]
GameData["area_effect"]["weapon_damage"]["armour_damage"]["hit_events"]["entry04"]["event"] = [[unit_ability_fx/imprisonment_30secs]]
GameData["area_effect"]["weapon_damage"]["armour_damage"]["hit_events"]["entry05"]["event"] = [[unit_ability_fx/imprisonment_30secs]]
GameData["area_effect"]["weapon_damage"]["armour_damage"]["life_leech_damage"] = 0
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry01"]["event"] = [[unit_ability_fx/imprisonment_2secs]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry02"]["event"] = [[unit_ability_fx/imprisonment_2secs]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry03"]["event"] = [[unit_ability_fx/imprisonment_2secs]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry04"]["event"] = [[unit_ability_fx/imprisonment_2secs]]
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"] = Reference([[tables\hit_event_entry.lua]])
GameData["area_effect"]["weapon_damage"]["hit_events"]["entry05"]["event"] = [[unit_ability_fx/imprisonment_2secs]]
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_05"]["modifier"] = Reference([[modifiers\enable_squad_upgrades.lua]])
...
GameData["requirements"]["required_2"]["mobvalue_required"] = 14.5
GameData["requirements"]["required_2"]["proximity_required"] = 50
...
GameData["spawned_entity_name"] = [[ebps\environment\gameplay\inq_imprisonment_dummy_2.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16020880]] -- - REQUIREMENT: The Librarian must be alone (unattached) to perform the Imprisonment!
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16020881]] -- - Offensive/forbiddance ability, that incarcerates a greater daemonic entity.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16020882]] -- - The Librarian targets the Greater Daemon and starts chanting the binding ritual.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16020883]] -- - For as long as he concentrates, the Grater Daemon is imprisoned within an energy cage.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$16020884]] -- - It cannot move but it can still defend itself, although melee-attacks are difficult to perform.
GameData["ui_info"]["help_text_list"]["text_06"] = [[$16020885]] -- - The Librarian is also locked in place, he cannot move, teleport or cast abilities.
GameData["ui_info"]["help_text_list"]["text_07"] = [[$16020886]] -- - The only way to willingly stop the effect prior to normal duration, is the (STOP) button!
GameData["ui_info"]["help_text_list"]["text_08"] = [[$16020887]] -- - Concentration disruption, or death of either the entity or the Librarian also ends the ability.
GameData["ui_info"]["help_text_list"]["text_09"] = [[$16020897]] -- - Left-click and target a Greater Daemonic entity to activate.
...
GameData["ui_instructional_msg"] = [[$16020888]] -- Left-click on an enemy Greater Daemon to Imprison it.
