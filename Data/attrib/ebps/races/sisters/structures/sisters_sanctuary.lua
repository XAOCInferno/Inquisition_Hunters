...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$4250010]] -- - Allows weapon upgrades on Battle Sister, Seraphim, and Celestian squads.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$4250011]] -- - Contains research to improve infantry squads and Veteran Superiors.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$4250012]] -- - Contains research that equips most buildings with Laud Hailers.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$4250008]] -- - Allows Building: Inferno Turret.  Ecclesiarchal Cathedral add-on (HQ Upgrade).
