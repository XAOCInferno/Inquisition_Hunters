...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$705102]] -- - Once the Energy Core is built you may upgrade the Monolith to a mobile fortress.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$4450172]] -- - Contains research to allow the Necron Lord to manifest the powerful Essence of a C'tan god.
GameData["ui_ext"]["ui_info"]["icon_name"] = [[necron_icons/necron_energy_core_icon]]
GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$705100]] -- Energy Core
