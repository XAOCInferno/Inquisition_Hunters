...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$4450155]] -- - Produces: Obliterators.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$4450156]] -- - Contains research that allows units to be possessed by the Bloodthirster or Daemon Prince.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$94214]] -- - Obliterators must be teleported directly onto the battlefield.
