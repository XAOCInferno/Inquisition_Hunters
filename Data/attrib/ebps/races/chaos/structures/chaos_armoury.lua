...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$4450154]] -- - Allows building:  Heavy bolter turret. Desecrated Fortress add-on (HQ upgrade).
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$94203]] -- - Contains research to improve infantry squads and Aspiring Champions.
