...
GameData["research_ext"]["research_table"]["research_02"] = [[research\inquisition_psy_power_1.lua]]
GameData["research_ext"]["research_table"]["research_03"] = [[research\inquisition_psy_power_2.rgd]]
GameData["research_ext"]["research_table"]["research_04"] = [[research\inquisition_officers_weapons.lua]]
...
GameData["spawner_ext"]["squad_table"]["squad_01"] = [[sbps\races\inquisition_daemonhunt\inquisition_squad_scholars.lua]]
GameData["spawner_ext"]["squad_table"]["squad_02"] = [[sbps\races\inquisition_daemonhunt\inquisition_squad_exorcist_sister.lua]]
GameData["spawner_ext"]["squad_table"]["squad_04"] = [[sbps\races\inquisition_daemonhunt\inquisition_squad_gk_terminator_apothecary.lua]]
GameData["spawner_ext"]["squad_table"]["squad_05"] = [[sbps\races\inquisition_daemonhunt\inquisition_squad_gk_librarian.lua]]
GameData["spawner_ext"]["squad_table"]["squad_06"] = [[sbps\races\inquisition_daemonhunt\inquisition_squad_gk_terminator_librarian.lua]]
GameData["spawner_ext"]["squad_table"]["squad_07"] = [[sbps\races\inquisition_daemonhunt\inquisition_squad_gk_apothecary.lua]]
...
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$16021611]] -- - This building enables most researches to be conducted and provides access to ancient Tomes and Artifacts.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16021612]] -- - (DH) Produces the Grey Knight Librarian, the Scholars squad, Weapon Servitors and Maintenance Servitors.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16021613]] -- - (GK) Produces the Grey Knight Terminator Librarian, Terminator Apothecaries and the Grey Knight Techmarine.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$16021614]] -- - Contains researches of the dreaded forbidden knowledge, and unlocks Inquisitorial psychic powers.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_06"] = [[$16021616]] -- 
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_07"] = [[$16021617]] -- 
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_08"] = [[$16021618]] -- 
GameData["ui_ext"]["ui_info"]["icon_name"] = [[inquisition_icons/librarium_icon]]
GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$16021610]] -- Librarium
