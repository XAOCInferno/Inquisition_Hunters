...
GameData["ability_ext"]["abilities"]["ability_01"] = [[abilities\inquisition_purification_decree_stale_commanders.lua]]
GameData["ability_ext"]["abilities"]["ability_02"] = [[abilities\inquisition_purification_decree_stale_daemons.lua]]
GameData["ability_ext"]["abilities"]["ability_03"] = [[abilities\inquisition_purification_decree_stale_infantry.lua]]
GameData["ability_ext"]["abilities"]["ability_04"] = [[abilities\inquisition_purification_decree_stale_vehicles.lua]]
GameData["ability_ext"]["abilities"]["ability_05"] = [[abilities\inquisition_purification_area.lua]]
GameData["ability_ext"]["abilities"]["ability_06"] = [[abilities\inquisition_diabolus_area.lua]]
...
GameData["ui_ext"]["ui_hotkey_name"] = [[inquisition_purification_decree]]
GameData["ui_ext"]["ui_index_hint"] = 9
GameData["ui_ext"]["ui_info"]["help_text_id"] = [[$94111]] -- 
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$16021622]] -- - The Inquisition places psychic seals, to preserve the area from contamination.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16021623]] -- - The enemy is slowed down when it enters the zone.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16021624]] -- - If the Protective Pentagrams research has been completed, the enemy also takes damage while in the zone.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$16021625]] -- - Can be upgraded to cause even more damage to the enemy.
GameData["ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$16021626]] -- - Detects infiltrators.
GameData["ui_ext"]["ui_info"]["icon_name"] = [[inquisition_icons/purification_decree_icon]]
GameData["ui_ext"]["ui_info"]["screen_name_id"] = [[$16021620]] -- Purification Decree
