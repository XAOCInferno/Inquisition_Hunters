...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$694850]] -- - Allows the Imperial General to add more leaders to the Command Squad.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$694851]] -- - Increases the maximum size of the Command Squad by 2.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$4550018]] -- - Increases maximum health of Command Squad members.
