...
GameData["requirements"]["required_10"]["structure_name"] = [[ebps\races\witch_hunters\structures\witch_hunters_generator.lua]]
...
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_sororitas_power_inc_research_1]]
