...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$674650]] -- - Allows Deathwatch Veterans to approach enemies at blinding speed.
...
GameData["ui_info"]["help_text_list"]["text_03"] = [[$674654]] -- - Furious Charge works only if the Deathwatch Veterans are in assault stance.
