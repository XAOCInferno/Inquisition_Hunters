...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9000369]] -- - Equips Archo-Flagellants with stimm injectors, implanted to their bodies.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9000370]] -- - Unlocks the Implant Stimm Injectors ability that can be used to set the Squad into a rampaging frenzy.
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_research_archoflagellant_implant_injectors_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9000368]] -- Implant Stimm Injectors Research
