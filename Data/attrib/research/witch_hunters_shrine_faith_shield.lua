...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9000529]] -- - The Reliquary of Faith is haunted by Holy Light.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9000530]] -- - Upgrades the army to the next Tier, allowing the production of more advanced units.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$9000531]] -- - Unlocks researches for Exorcist, Immolator and Inquisition Incarcerator tanks.
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_armorium_addon_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9000528]] -- Holy Light  (Tier III)
