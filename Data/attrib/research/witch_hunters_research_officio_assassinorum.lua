...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9002246]] -- - Makes formal request to the Inquisition High Command for special operations assistance.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9002247]] -- - Allows the requisition of two highly trained assassins, the Callidus and the Eversor.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$9002248]] -- 
GameData["ui_info"]["help_text_list"]["text_04"] = [[$9002249]] -- 
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_officio_assassinorum_upgrade_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9002245]] -- Officio Assassinorum Inquiry
