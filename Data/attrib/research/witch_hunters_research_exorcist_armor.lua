...
GameData["modifiers"]["modifier_01"]["target_type_name"] = [[witch_hunters_exorcist]]
GameData["modifiers"]["modifier_02"] = Reference([[modifiers\default_weapon_modifier_hardpoint2.lua]])
GameData["modifiers"]["modifier_02"]["target_type_name"] = [[witch_hunters_exorcist_sanctorum]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9000331]] -- - Sororitas and Inquisition crews add extra armour plating to provide more protection.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9000332]] -- - Exorcists equipped with extra armour receive reduced damage from the enemy.
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_research_exorcist_extra_armor_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9000330]] -- Exorcist Blessed Armour Research
