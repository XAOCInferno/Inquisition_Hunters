...
GameData["modifiers"]["modifier_01"]["target_type_name"] = [[witch_hunters_squad_battle_sister]]
GameData["modifiers"]["modifier_01"]["value"] = 2
GameData["modifiers"]["modifier_02"] = Reference([[modifiers\max_upgrades_squad_modifier.lua]])
GameData["modifiers"]["modifier_02"]["target_type_name"] = [[witch_hunters_squad_seraphim]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9000393]] -- - Unlocks new weapons upgrades for Sisters of Battle and Seraphim Squads.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9000394]] -- - Upgrades maximum number of weapons Sisters of Battle and Seraphim Squads can carry.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$9002162]] -- - Allows access to Sororitas Bionics Equipment Research.
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_research_sororitas_dominion_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9000392]] -- Sororitas Dominion Equipment Research
