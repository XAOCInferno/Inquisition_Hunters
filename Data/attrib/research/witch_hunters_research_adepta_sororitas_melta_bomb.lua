...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9000321]] -- - Equips the regular members of Seraphim Squads, with Melta Bombs.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9000322]] -- - Does massive damage to enemy Vehicles and Buildings.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$9000323]] -- - Melta Bombs are very short range and do not affect Infantry.
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_research_melta_bomb_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9000320]] -- Seraphim Melta Bombs Research
