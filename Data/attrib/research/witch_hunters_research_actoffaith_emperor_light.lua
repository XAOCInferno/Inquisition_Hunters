...
GameData["ui_hotkey_name"] = [[guard_enginseer]]
GameData["ui_index_hint"] = 11
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_id"] = [[$9000000]] -- 
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9000309]] -- - Celestians will die when the Emperor is ready to accept their souls, and not before.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9000310]] -- - Light of the Emperor protects them from morale damage and death for a short time.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$9000311]] -- - The presence of an Imagifer is mandatory for Celestians to cast this Act of Faith.
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_research_actoffaith_emperor_light_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9000308]] -- Light of the Emperor Act of Faith Research
