...
GameData["requirements"]["required_1"]["research_name"] = [[inquisition_branch_inq]]
...
GameData["requirements"]["required_2"]["research_name"] = [[inquisition_branch_inq]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16022031]] -- - The army force deployment follows a rigid discipline, specialising in Grey Knights troops.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16022032]] -- - The Ordo Malleus rapidly dispatches Grey Knights to counter the imminent threat.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16022033]] -- - Limited variety of troops, with emphasis in powerful and heavily armoured units.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16022034]] -- - NOTE: Delayed vehicle deployment, in favour or Grey Knights' pre-emptive availability.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$16022035]] -- - Only one type of force deployment can be chosen.
GameData["ui_info"]["help_text_list"]["text_06"] = [[$16022036]] -- 
GameData["ui_info"]["help_text_list"]["text_07"] = [[$16022037]] -- 
GameData["ui_info"]["help_text_list"]["text_08"] = [[$16022038]] -- 
GameData["ui_info"]["icon_name"] = [[inquisition_icons/branch_gk]]
GameData["ui_info"]["screen_name_id"] = [[$16022030]] -- Grey Knights
