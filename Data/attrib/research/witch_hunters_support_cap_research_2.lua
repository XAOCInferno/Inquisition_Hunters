...
GameData["requirements"]["required_1"]["research_name"] = [[witch_hunters_support_cap_research_1]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9000375]] -- - Increases the number of vehicles you can have by increasing your Vehicle Cap.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9000376]] -- - Vehicle Cap determines how many vehicles you can deploy.
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_research_arbites_squad_support_cap_increase_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9000374]] -- Vehicle Cap Increase
