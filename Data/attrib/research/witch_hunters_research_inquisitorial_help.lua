...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9000286]] -- - Makes formal request to the Inquisition High Command for battlefield assistance.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9000287]] -- - Allows the Female Inquisition Command Squad to be fielded.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$9000288]] -- - Her presence on the field of war will surely turn the tide in our favour!
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_research_throne_judgement_icon_b]]
GameData["ui_info"]["screen_name_id"] = [[$9000285]] -- Inquisitorial Help
