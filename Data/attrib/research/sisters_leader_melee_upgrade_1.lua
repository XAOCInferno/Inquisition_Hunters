...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$4350060]] -- - Equips the Canoness with the Brazier of Holy Fire.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$4350061]] -- - Equips all Veteran Superiors with Power Swords.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$4350062]] -- - Power Swords ignore armor, making them very effective against Heavy Infantry.
