...
GameData["requirements"]["required_2"]["structure_name"] = [[ebps\races\witch_hunters\structures\witch_hunters_inquisition_armorium.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9000364]] -- - Inquisition is allowed to torture to death the Warp daemon they control.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9000365]] -- - Torturing the Warp daemon just multiply Incarcerator attack powers.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$9000398]] -- - NOTE: The warp energy siphoned from the daemon corrupts the Incarcerator.
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_research_incarcerator_horror_torture_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9000363]] -- Incarcerator Torture Instructions Research
