...
GameData["ui_hotkey_name"] = [[sisters_shrine]]
GameData["ui_index_hint"] = 8
GameData["ui_info"] = Reference([[tables\ui_info_table.lua]])
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9000384]] -- - Grants access to Arbites Heavy Weapons, for Arbites Fire Support Squads.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9000385]] -- - Increases the number of weapon upgrades to the Arbites Fire Support Squads.
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_research_arbites_maximum_support_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9000383]] -- Arbites Heavy Weapons Research
