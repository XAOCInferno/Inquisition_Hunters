...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16022911]] -- - Equips various members of the army with grenades and bombs.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16022912]] -- - Bodyguards, Purgators and Exorcists are equipped with Frag Grenades.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16022913]] -- - Interceptors are equipped with Melta Bombs.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16022914]] -- - The Techmarine gets both Frag Grenades and Melta Bombs.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$16022915]] -- - Unlocks the research of Empyrean Brain Mines and Krak Grenades Wargear.
GameData["ui_info"]["help_text_list"]["text_06"] = [[$16022916]] -- 
GameData["ui_info"]["help_text_list"]["text_07"] = [[$16022917]] -- 
GameData["ui_info"]["help_text_list"]["text_08"] = [[$16022918]] -- 
GameData["ui_info"]["icon_name"] = [[inquisition_icons/fraggmeltaresearch_icon]]
GameData["ui_info"]["screen_name_id"] = [[$16022910]] -- Wargear: Frag Grenades and Melta Bombs
