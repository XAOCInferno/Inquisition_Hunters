...
GameData["modifiers"]["modifier_01"]["target_type_name"] = [[inquisition_squad_dreadknight]]
...
GameData["requirements"]["required_10"]["structure_name"] = [[ebps\races\inquisition_daemonhunt\structures\inquisition_astra_telepathica_gk.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16021731]] -- - Equips the Dreadknight with a powerful Personal Teleporter.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16021732]] -- - Allows swift, lightning-fast jumps over vast distances.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16021733]] -- - Upon arrival to a destination, the dimensional unfolding causes damage to nearby infantry.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16021734]] -- 
GameData["ui_info"]["help_text_list"]["text_05"] = [[$16021735]] -- 
GameData["ui_info"]["icon_name"] = [[inquisition_icons//dk_personalteleporter_research_icon]]
GameData["ui_info"]["screen_name_id"] = [[$16021730]] -- Personal Teleporter Wargear
