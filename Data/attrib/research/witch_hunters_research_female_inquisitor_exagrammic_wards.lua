...
GameData["modifiers"]["modifier_01"] = Reference([[modifiers\ability_chaos_purge_the_weak_event.lua]])
GameData["modifiers"]["modifier_01"]["application_type"] = Reference([[type_modifierapplicationtype\tp_mod_apply_to_entity_type.lua]])
GameData["modifiers"]["modifier_01"]["target_type_name"] = [[witch_hunters_female_inquisitor]]
...
GameData["modifiers"]["modifier_02"]["target_type_name"] = [[witch_hunters_squad_female_inquisitor_command_squad]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$9000396]] -- - The Inquisitor is protected by powerful canticles of Faith and devotion.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$9000397]] -- - Enemy psykers within an area cannot use any of their power abilities.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$9000532]] -- - Grants additional Henchmen to the Inquisitor Squad.
GameData["ui_info"]["icon_name"] = [[witch_hunters_icons/witch_hunters_research_female_inquisitor_exagrammic_wards_icon]]
GameData["ui_info"]["screen_name_id"] = [[$9000395]] -- Inquisitor Exagrammic Wards Research
